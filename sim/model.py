        ...
        if self._check_collosion == True:
            ...
            for collision in collision_list:
                ...
                for object in collision:
                    ...
                    new_inclination = object.inclination + random.sample([-3, -2, -1, 1, 2, 3])
                    if new_inclination > 180:
                        new_inclination -= 180
                    if new_inclination < 0:
                        new_inclination += 180

                    self.objects.append(Object(object.epoch, object.mean_motion, object.eccentricity, 
                    new_inclination, object.ra_of_asc_node, object.arg_of_pericenter, object.mean_anomaly, 
                    max_norad_cat_id, object.semimajor_axis, object.period, object.apoapsis, 
                    object.periapsis, object.object_type, object.rcs_size, object.country_code, object.launch_date))
